...
public final class PaperPlaneRegistries {
    public static final Supplier<Item> PAPER_PLANE = memoize(() -> Registry.register(
        Registry.ITEM, id("paper_plane"), new PaperPlaneItem(PaperPlaneFabricCreativeTabs.configure(new Item.Properties().stacksTo(16)), PlaneKind.NORMAL)
    ));
    public static final Supplier<Item> SOGGY_PAPER_PLANE = memoize(() -> Registry.register(
        Registry.ITEM, id("soggy_paper_plane"), new SoggyPaperPlaneItem(PaperPlaneFabricCreativeTabs.configure(new Item.Properties().stacksTo(16)))
    ));
    public static final Supplier<Item> ENDER_PAPER_PLANE = memoize(() -> Registry.register(
        Registry.ITEM, id("ender_paper_plane"), new PaperPlaneItem(PaperPlaneFabricCreativeTabs.configure(new Item.Properties().stacksTo(1).fireResistant()), PlaneKind.ENDER)
    ));
